...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference("Endereco.count") do
      post enderecos_url, params: { endereco: { numero: @endereco.numero, rua: @endereco.rua } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { numero: @endereco.numero, rua: @endereco.rua } }
